...
{
    public partial class SalaryClauseDeductionForm : Form
    {
        DatabaseInterface DB;
        SalaryClause _SalaryClause;
        Employee _Employee;
        public SalaryClauseDeductionForm(DatabaseInterface db, Employee Employee_)
        {
            DB = db;
            InitializeComponent();
            _Employee = Employee_;
        ...
        public SalaryClauseDeductionForm(DatabaseInterface db, SalaryClause SalaryClause_, bool Edit)
        {
            DB = db;
            InitializeComponent();
            ...
            if (buttonSave.Name == "buttonAdd")
            {
                try
                {
                    ...
                    bool success = new SalaryClauseSQL(DB).Add_SalaryClause
                      (_Employee.EmployeeID, textBoxClauseDesc.Text, SalaryClause.TYPE_Deduction,
